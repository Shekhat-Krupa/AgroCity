    ...
    <div class="wrapper">
        ...
        <img src="../images/user-icon1.png" alt="Avatar">
            ...
            <table class="tbl">
                ...
                <tr>
                    <td><input type="text" name="gst_no" class="input-box1" placeholder="GST Number"></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <input type="submit" name="submit" value="Add Company" class="signup-btn">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        <a href="login.php"><input type="button" name="button" value="Login" class="signup-btn"></a>
                    </td>
                </tr>
            </table>
        </form>
